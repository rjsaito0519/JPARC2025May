...
{   
    ...
    std::vector<TTreeReaderValue<std::vector<Double_t>>*> kvc2_adc_vec = {
        &kvc2_adc_a,
        &kvc2_adc_b,
        &kvc2_adc_c,
        &kvc2_adc_d
    ...
    std::vector<Double_t> par = param::kvc2_opg_fit.count(key.Data()) ? param::kvc2_opg_fit.at(key.Data()) : param::kvc2_opg_fit.at("default");
